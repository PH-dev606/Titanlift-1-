        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          {templates.slice(0, 4).map(template => (
            <Link 
              ...
              className="bg-gradient-to-br from-gray-900 to-slate-950 border border-gray-800 p-5 rounded-3xl hover:border-indigo-500/50 hover:to-slate-900 transition-all group relative overflow-hidden shadow-lg"
            >
      ...
      <div className="grid gap-3.5">
        {templates.map(template => (
          <div key={template.id} className="relative group">
            <div className={`bg-gradient-to-br from-gray-900 to-slate-950 border border-gray-800 p-5 rounded-[1.8rem] transition-all shadow-lg ${isManageMode ? 'ring-2 ring-indigo-500/20' : 'hover:border-indigo-500/50 hover:to-slate-900'}`}>
